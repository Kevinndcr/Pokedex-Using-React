...
const SegundaGen = () => {
    ...
    return (
        <div>
            ...
            <p className="textito">Pokémons de la segunda generación</p>
                ...
                <tbody>
                    {data.map((pokemon, index) => (
                        <tr key={index}>
                            ...
                            <td>
                                <img
                                    src={`https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/${index + 152}.png`}
                                    width="130"
                                    height="130"
